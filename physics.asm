...
Physics__QuadTree__clear:
	...
	li $t5, 0
Physics__QuadTree__clear_for:
	beq $t5, 32, Physics__QuadTree__clear_forEnd
	
	addi $t1, $t1, 4
	sw $zero, ($t1)
	
	sw $zero, ($t0)
	addi $t0, $t0, QUAD_TREE_THREESHOLD_OFFSET
	
	addi $t5, $t5, 1
Physics__QuadTree__clear_forEnd:
	jr $ra
